...
Supports any-to-any transformations: language version upgrades (ex. Java, Python, Node.js),
...
2. **Never modify IAM beyond what's documented** — Only create/attach the specific
   policies described in this skill (AWSTransformCustomFullAccess). Never create admin policies,
...
| [single-transformation.md](references/single-transformation.md) | Applying one TD to one repo |
...
## Issues
https://github.com/aws-samples/aws-transform-custom-samples/issues
